...
func MyInit() {
	space = map[int]string{1: "   ", 2: "   ", 3: "   ", 4: "   ", 5: "   ", 6: "   "}
	mapList = map[string]map[int]string{
		" ": {1: "   ", 2: "   ", 3: "   ", 4: "   ", 5: "   ", 6: "   "},
...
func nMixStr(last *map[int]string, result *map[int]string, apd *map[int]string, lst bool) {
	var l = len((*apd)[1])
	if l == 0 {
		apd = &space
		l = len((*apd)[1])
